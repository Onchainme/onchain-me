...
export function LandingCta() {
  return (
    ...
    >
      ...
      <div className="relative max-w-[880px] mx-auto px-3 sm:px-12">
        ...
        <h2 className="font-grotesk font-bold text-[42px] sm:text-[64px] md:text-[80px] mt-6 leading-[1] tracking-[-0.03em]">
          Mint your <span className="glow-m">land</span>.
          <br />
          Show your <span className="glow-c">story</span>.
        </h2>

        <p className="font-grotesk text-[18px] sm:text-[20px] text-muted-neon mt-6">
