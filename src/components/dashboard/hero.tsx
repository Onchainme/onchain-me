      ...
      >
        <div className="flex items-center gap-5 flex-wrap">
          ...
          <div className="flex-1 min-w-[240px]">
            <div className="font-silk text-[11px] text-muted-neon tracking-[0.16em]">
              WELCOME BACK
            </div>
            <div className="font-px text-[19px] mt-1.5 leading-snug">
            ...
            <div className="font-pixel-body text-sm text-muted-neon mt-1.5">
          ...
          <div className="flex flex-col gap-2 min-w-[200px]">
            ...
            <Button variant="ghost" size="sm" asChild>
              <Link href="/my-land" className="w-full">
                → Open My Land
              </Link>
            </Button>
          </div>
  ...
  return (
    <div className="flex items-end gap-5 flex-wrap">
      <div className="flex-1 min-w-[320px]">
        ...
        <div className="font-silk text-[13px] text-ink-2 tracking-[0.15em]">
          YOUR WALLET · YOUR WORLD
        </div>
        <div className="w-60 h-[3px] mt-2 bg-cyan-neon shadow-[0_0_10px_var(--color-cyan-neon)]" />
        <div className="font-pixel-body text-sm text-muted-neon mt-3.5 max-w-lg">
      ...
      <Card accent="violet" padding="default" className="min-w-[280px]">
        <div className="flex items-center gap-6">
          <div>
            <div className="font-silk text-[9px] text-muted-neon">LANDS MINTED</div>
            <div className="font-px glow-v text-[22px] mt-0.5">
              {STATS.mintedTotal.toLocaleString()}
            </div>
          </div>
          <div>
            <div className="font-silk text-[9px] text-muted-neon">TODAY</div>
            <div className="font-px glow-y text-[22px] mt-0.5">+{STATS.today}</div>
          </div>
        </div>
      </Card>
    </div>
